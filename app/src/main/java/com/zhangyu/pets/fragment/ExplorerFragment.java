...
public class ExplorerFragment extends BaseFragment
    ...
    private String defaultUrl = "http://100.64.20.167/explorer/explorer.htm";

    public static ExplorerFragment newInstance(int sectionNumber) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        int resourceId = R.layout.fragment_pet_explorer;
