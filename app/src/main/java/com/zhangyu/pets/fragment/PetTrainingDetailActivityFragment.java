 ...
 */
public class PetTrainingDetailActivityFragment extends BaseFragment
    ...
    public PetTrainingDetailActivityFragment() {
    }

    public static PetTrainingDetailActivityFragment newInstance(Context context, String courseId) {
        PetTrainingDetailActivityFragment fragment = new PetTrainingDetailActivityFragment();
